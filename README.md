# Hi, I'm Dyami Connell. 👋

### HVAC TAB Technician & Open Source Developer in San Francisco.

I build automation tools for the mechanical trades, bridging the gap between field work and software.
...
* **Tool Tracking Software**: (https://protooltrack.com)** Scan QR Codes for tool checkout
** 🛠 Tech Stack:**
* **Languages**: Python, JavaScript
* **Industry Tools**: AABC Standards, Hydronic Balancing, Airflow Dynamics

** 🔗 Connect with me:**
* 🌐 **Portfolio**: [dyamiconnell.com](https://dyamiconnell.com)
* 📝 **Technical Blog**: [Medium](https://medium.com/@dyamiconnell)
